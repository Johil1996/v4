...
<table class="table table-borderless mb-0">					
		...
		<thead>
			...
			<tr>
                ...
                <th>
                <input type="text" name="video_name" value="<?php echo $row['video_name']; ?>" disabled
			...
			<tr>
                ...
                <th >
                <input type="text" name="duration" value="<?php echo $row['duration'];?> Seconds" disabled
			...
			<tr >
                ...
                <th >
                <input type="text" name="duration" value="<?php echo $row['spots'];?> Spots" disabled
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control form-control-md"> 
                 </th>
			</tr>
			...
			<tr hidden>
                ...
                <th >
                <input type="text" name="video_name" value="<?php echo $row['category'];?>" disabled
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control form-control-md">  </th>
			</tr>
			...
			<tr hidden>
                ...
                <th>
                <input type="hidden" name="video_name" value="Approve" disabled
                	   style="color: gray; font-size: 12px; font-weight:normal;background: none;  " class="form-control form-control-md">  </th>
			</tr>
			...
			<tr>
                ...
                <th>
                <input type="text" name="video_name" value="<?php echo date("F d, Y - h:i A", strtotime ($row['date_time']));?>" disabled
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control form-control-md">  
                </th>
			</tr>
