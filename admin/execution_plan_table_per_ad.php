    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0"style="font-weight: normal"> Execution Plan per Ad </h1>
                    </div>
              ...
              <?php
                ...
                $query = mysqli_query($con,"SELECT video_name, id, count,  video, duration, category, play_start, end_start, video_status, date_time, video_spots_no_yes, name FROM playlist_video 
...
<form method='POST' action='execution_plan_details_per_ad.php?id=$video_name'>

                      <div class='app-card-footer mt-auto'>
                               <a href='execution_plan_details_per_ad.php?id=$video_name'> 
...
echo " 
 ...
 <form method='POST' action='execution_plan_details_per_ad_no_spots.php?id=$video_name'>

                      <div class='app-card-footer mt-auto'>
                               <a href='execution_plan_details_per_ad_no_spots.php?id=$video_name'> 
                                    <button class='btn app-btn-secondary' 
                                    style='font-size: 12px; font-family: sans-serif;'> View </button>
                                </a>
                            </div>
 ...
 <input type='hidden' name='video_name' value='$video_name'>
    ...
    let A = new jojo1.DataTable(Client);
              ...
              <?php
                ...
                $query = mysqli_query($con,"SELECT video_name, id, count,  video, duration, play_start, end_start, category, video_status, date_time, name FROM playlist_video 
...
<form method="POST" action="execution_plan_details_per_ad.php?id=<?php echo $row['video_name'];?>">
                            ...
                            <div class="app-card-footer mt-auto">
                               <a href="execution_plan_details_per_ad.php?id=<?php echo $row['video_name']; ?>"> 
                                    <button class="btn app-btn-secondary" 
                                    style="font-size: 12px; font-family: sans-serif;"> View </button></a>
                            </div>

<input type="hidden" name="end_start" value="<?php echo $end_play;?>">
    ...
    let B = new jojo1.DataTable(Site_Partner);
              ...
              <?php
                ...
                $query = mysqli_query($con,"SELECT video_name, id, count,  video, duration, category, play_start, end_start, video_status, date_time, name FROM playlist_video 
...
<input type="hidden" name="end_start" value="<?php echo $end_play;?>">
   ...
   <!-- CLIENT END -->
                ...
                $query = mysqli_query($con,"SELECT video_name, id, count, video, duration, site_name, category, video_status, date_time, name , end_start, play_start FROM playlist_video 
                WHERE end_start <= '$date' AND video_status = '$Deactivate' GROUP BY video_name");
                while($row = mysqli_fetch_array($query)){
