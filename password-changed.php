...
<html lang="en"> 
<head>
    <title> A I R C A S T | Changed Password </title>
...
<form action="index.php" method="POST" autocomplete="" class="auth-form login-form">
        ...
        <button type="submit" name="login-now" value="login-now" class="btn app-btn-primary w-100 theme-btn mx-auto">login-now</button>
        </div>
