<?php
    ...
    if ($startdate == "" || $enddate == "") {
        ...
        <?php
            ...
            if ($content == "Content") {
                $query = "SELECT * FROM playlist_data WHERE site_name='$content' AND date_time BETWEEN '$startdate' AND '$enddate' AND 
    ...
    $query = "SELECT * FROM playlist_data WHERE site_name = '".$_REQUEST['id']."' ORDER by id DESC ";
        $searchResult = date_time($query);
    }
...
?>
                ...
                <!-- WELCOME START -->
                <h1 class="app-page-title" style="font-weight: normal;"> Spot Per Site |
...
<form method='POST' action='spot_per_site_data.php?id=$video_name'>

                      <div class='app-card-footer mt-auto'>
                               <a href='spot_per_site_data.php?id=$video_name'> 
...
echo " 
 ...
 <form method='POST' action='spot_per_site_data_no_spots.php?id=$video_name'>

                      <div class='app-card-footer mt-auto'>
                               <a href='spot_per_site_data_no_spots.php?id=$video_name'> 
                                    <button class='btn app-btn-secondary' 
                                    style='font-size: 12px; font-family: sans-serif;'> View </button>
                                </a>
                            </div>
