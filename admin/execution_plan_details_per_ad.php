<?php
    ...
    if ($startdate == "" || $enddate == "") {
        ...
        if ($content == "Content") {
            $query = "SELECT * FROM reference WHERE end_start = '$end_play' AND video='$content' AND g_date BETWEEN '$startdate' AND '$enddate' AND video_name = '".$_REQUEST['id']."' ORDER by id DESC ";
    ...
    $query = "SELECT * FROM reference WHERE end_start = '$end_play' AND video_name = '".$_REQUEST['id']."' ORDER by id DESC ";
    $searchResult = filtertable($query);
...
<form method="POST" action="execution_plan_details_per_ad.php">

                <!-- WELCOME START -->
                <h1 class="app-page-title" style="font-weight: normal"> Execution Plan per Ad </h1>
                  ...
                  <div class="app-card-header p-3" >
                    <div class="row justify-content-between align-items-center" >
                      <div class="col-auto">
                        <div class="card-header-action">
                          <span style="color: black; font-size: 13px; font-weight:normal;">
                          <span class="nav-icon" style="padding: 3px 5px"><?php include 'icon/transaction.php'?></span> Execution Plan per Ad Data</span>
                        </div>
                      </div>
                    </div>
                  </div>
...
<form method="POST" action="execution_plan_details_per_ad.php?id=<?php echo $row['video_name'];?>">
