...
<?php
 ...
 if ($vid == "vid") {
                $query = "SELECT * FROM video WHERE category='$vid' ORDER BY id desc ";
			...
			<div class="app-card app-card-doc shadow-sm  h-100">
                            ...
                            <div class="app-card-thumb-holder p-3" >
                                <div class="app-card-thumb">
                                    ...
                                    <video class="thumb-image" autoplay muted style="margin-top: 0px; box-shadow: none; margin-top: 2%;">
	...
	<h4 class="app-doc-title truncate mb-0"><a href="#file-link"><?php echo $row['video_name'];?></a></h4>
		...
		<div class="app-doc-meta">
			...
			<ul class="list-unstyled mb-0">
				...
				<li> <span style="color: black; font-size: 12px; font-weight:normal;">Uploaded By : 
				     </span style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['name'];?>
				</li>								    	
				
				<li> <span style="color: black; font-size: 12px; font-weight:normal;">Category : 
				     </span style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['category'];?>
				</li>
...
echo " <span style='color: black; font-size: 12px; font-weight:normal;'></span style='color: black; font-size: 12px; font-weight:normal;'>";

                } else {


echo " <span style='color: black; font-size: 12px; font-weight:normal;'>Execlusive Selling : </span style='color: black; font-size: 12px; font-weight:normal;'> $Yes";
...
<form method='POST' action='playlist_add.php?id=$id'>

				<a class='dropdown-item' href='playlist_add.php?id=$id'><i class='fa fa-plus'></i><span style='margin-left: 10px;'> Add To Playlist </span></a>
...
<form method='POST' action='playlist_add_no_spots.php?id=$id'>

				<a class='dropdown-item' href='playlist_add_no_spots.php?id=$id'><i class='fa fa-plus'></i><span style='margin-left: 10px;'> Add To Playlist </span></a>
...
<table class="table table-borderless mb-0">
            ...
            <tr >
                ...
                <th class="meta">
                    <select  name="video_spots_no_yes" style="color: gray; font-size: 12px; font-weight:normal; background:none;" 
                       class="form-control ">
                        <option value="Yes">Per Spot</option>
                        <option value="No">Exclusive Selling</option>
                    </select>
                </th>
            </tr> 
