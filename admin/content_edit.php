		...
		<thead>
			...
			<tr>
                ...
                <input type="text" name="video_name" value="<?php echo $row['video_name']; ?>" 
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control">  </th>
			</tr>
			...
			<tr>
                ...
                <input type="text" name="duration" value="<?php echo $row['duration'];?> Seconds" readonly
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control"> 
                 </th>
			</tr>
			...
			<tr>
                ...
                <th >
                <input type="text" name="spots" value="<?php echo $row['spots'];?>" readonly
                	   style="color: gray; font-size: 12px; font-weight:normal; background: none; " class="form-control"> 
                </th>
			</tr>
