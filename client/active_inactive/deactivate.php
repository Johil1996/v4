...
$id = $_GET['id'];
    ...
    mysqli_query($con,"UPDATE playlist_video SET video_status = '$Deactivate' WHERE  id = '$id'");
    ...
    mysqli_query($con,"UPDATE reference SET video_status = '$Deactivate' WHERE site_name = '$playlistname' AND videojojo_id = '$video_id'");
