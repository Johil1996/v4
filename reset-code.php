...
<html lang="en"> 
<head>
    <title> A I R C A S T | Reset Code </title>
...
<form action="forgot-password.php" method="POST" autocomplete="" class="auth-form login-form">
        ...
        <button type="submit" name="check-reset-otp" value="Submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Submit</button>
        </div>
