...
<?php
    ...
    $id = "SELECT * FROM playlist_video WHERE name='$Name' and category='Client' and site_name ='".$_REQUEST['id']."'";
    ...
    $query = mysqli_query ($con,"SELECT * FROM playlist_video WHERE name='$Name' and category='Client' and site_name = '$id'");
...
?>
			    ...
			    <!-- SEARCH START -->
			            <h1 class="app-page-title"  style="font-weight: normal;"> Playlist | 
			            	<input type="text" value="<?php echo $row['site_name']; ?>"  style="color: black; font-size: 15px; font-weight:normal; background: none; border: none; " >
			            </h1>
...
<?php ?>
			    ...
			    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link" id="orders-pending-tab" data-bs-toggle="tab" href="#orders-pending" role="tab" aria-controls="orders-pending" aria-selected="false" style="font-weight: normal; font-family: sans-serif;">Complete</a>
...
<?php
    ...
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
...
<?php
    ...
    include 'database/database.php';
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND eigth_to_ten='$a' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
    $result = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($result)) {
...
<?php
    ...
    include 'database/database.php'; 
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND ten_to_twelve='$b' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
    $result = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($result)) {
...
<?php
    ...
    include 'database/database.php';
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND twelve_to_two='$c' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
    $result = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($result)) {
...
?>
				...
				<td class="cell" style="color: black; font-size: 12px; font-weight:normal;"> 12am to 2pm 
				</td>
...
<?php
    ...
    include 'database/database.php';
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND two_to_four='$d' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
    $result = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($result)) {
...
<?php
    ...
    include 'database/database.php';
    $query = "SELECT * FROM playlist_video WHERE video_status='$active' AND four_to_six='$e' AND name='$Name' AND end_start >= '$date' AND
    site_name = '".$_REQUEST['id']."' ORDER by id DESC LIMIT 10 ";
    $result = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($result)) {
...
<?php
    ...
    $query = "SELECT * FROM playlist_video WHERE name='$Name' AND video_status = '$Deactivate' AND end_start > '$date' AND
...
<form method="POST" action="playlist_view_details.php?id=<?php echo $row['id'];?>">

                            <div class="app-card-footer mt-auto">
                               <a href="playlist_view_details.php?id=<?php echo $row['id'];?>"> 
                                    <button class="btn app-btn-secondary" style="font-size: 13px; "> View </button></a>
                            </div>
