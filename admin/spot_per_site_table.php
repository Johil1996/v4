...
<?php include'header.php' ?>
    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			    ...
			    <!-- WELCOME START -->
			    <h1 class="app-page-title" style="font-weight: normal"> Spot Per Site </h1>
                            ...
                            <div class="app-card-body p-3 p-lg-4">
                                <div class="table-responsive">
                                 ...
                                 <table id="table1" class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th class="cell" colspan="2" style="text-align: center; font-weight:normal;">Site & Area</th>
              ...
              <?php
                ...
                $query = mysqli_query($con,"SELECT site_name, active, inactive, video_status, SUM(active) AS active, SUM(inactive) AS inactive FROM playlist_video GROUP BY site_name");
               ...
               ?>
						...
						<td class="cell" style="color: black; font-size: 12px; font-weight:normal;">
                               ...
                               <a href="spot_per_site.php?id=<?php echo $row['site_name']; ?>" style="margin-left: 20px;"> 
