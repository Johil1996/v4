<?php
    ...
    if ($startdate == "" || $enddate == "") {
        ...
        if ($content == "Content") {
            $query = "SELECT * FROM reference WHERE end_start = '$end_play' AND site_name = '$site' AND video='$content' AND g_date BETWEEN '$startdate' AND '$enddate' AND video_name = '".$_REQUEST['id']."' ORDER by id DESC ";
    ...
    $query = "SELECT * FROM reference WHERE end_start = '$end_play' AND site_name = '$site' AND video_name = '".$_REQUEST['id']."' ORDER by id DESC ";
    $searchResult = filtertable($query);
...
<form method="POST" action="execution_plan_details.php">

                <!-- WELCOME START -->
                <h1 class="app-page-title" style="font-weight: normal"> Execution Plan Per Site | <span style="font-size: 15px; color: gray"><?php echo $row['site_name']; ?></span></h1>
...
<form method="POST" action="execution_plan_details.php">
                         ...
                         <th class="meta" style="color: black; font-size: 13px; font-weight:normal;"> Spots Consumed per Site </th>
                        ...
                        <th class="meta" style="color: black; font-size: 13px; font-weight:normal;"> Frequency Consumed per Site </th>
...
<input type="hidden" name="end_start" value="<?php echo $end_play;?>" id = "butt">
              ...
              <?php
                ...
                $query = mysqli_query($con,"SELECT video_name, video, id, active, end_start, inactive, video_status, date_time, play_start, end_start, site_name, 
...
<form method="POST" action="spot_view_details.php?id=<?php echo $row['video_name'];?>">
                             
                                <div class="app-card-footer mt-auto" style="margin-top: 20px; padding: 10px 5px ; float: right;">
                                    <a class="dropdown-item" href='spot_view_details.php?id=<?php echo $row['video_name'];?>'>
                                    <button  name="save" class="btn app-btn-secondary"  style="font-size: 12px; font-family: sans-serif;"> View Details </button>
                                    </a>
                                </div>
                  ...
                  <div class="app-card-header p-3" >
                    <div class="row justify-content-between align-items-center" >
                      <div class="col-auto">
                        <div class="card-header-action">
                          <span style="color: black; font-size: 13px; font-weight:normal;">
                          <span class="nav-icon" style="padding: 3px 5px"><?php include 'icon/transaction.php'?></span> Execution Plan per Site Data</span>
                        </div>
                      </div>
                    </div>
                  </div>
...
<form method="POST" action="execution_plan_details.php?id=<?php echo $row['video_name'];?>">
                                   ...
                                   <table id="table1" class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell" style="font-weight: normal;"> Day </th>
                                                <th class="cell" style="font-weight: normal;"> Date </th>

                                                <th class="cell" style="font-weight: normal;"> 8 to 10am 
                                                    <br><span style="color: black; font-size: 11px; color: gray;"> Frequency </span></th>

                                                <th class="cell" style="font-weight: normal;"> 10 to 12pm 
                                                    <br><span style="color: black; font-size: 11px; color: gray;"> Frequency </span></th></th>

                                                <th class="cell" style="font-weight: normal;"> 12 to 2pm 
                                                    <br><span style="color: black; font-size: 11px; color: gray;"> Frequency </span></th></th>

                                                <th class="cell" style="font-weight: normal;"> 2 to 4pm 
                                                   <br><span style="color: black; font-size: 11px; color: gray;"> Frequency </span></th></th>

                                                <th class="cell" style="font-weight: normal;"> 4 to 6pm 
                                                    <br><span style="color: black; font-size: 11px; color: gray;"> Frequency </span></th></th>                 
                                            </tr>
                                        </thead>
                                   <tbody>
...
<form method="POST" action="execution_plan_details.php">
                ...
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['video_status'];?></td>  

                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo date("l", strtotime ($row['g_date']));?></td>
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo date("F d, Y", strtotime ($row['g_date']));?></td>

                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['ETspots'];?></td>  
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['TTspots'];?></td>  
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['TTwospots'];?></td>  
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['TFspots'];?></td>
                <td class="cell" style="color: black; font-size: 12px; font-weight:normal;"><?php echo $row['FSspots'];?></td>                                                                  
