...
<form method="GET" action="playlist_add_data_no_spots.php">
...
?>
                ...
                <input type="hidden" placeholder="Spot Content" name="AA_Spots" value="<?php echo $row['spots'];?>" 
                class="form-control AA_Spots" readonly>  
       ...
       <tr>
                ...
                <th class="meta">
                <input type="number"  name="Price_per_Spots" id="Price_per_Spots" value="2" class="form-control Price_per_Spots" placeholder="Price*"
                       style="color: gray; font-size: 12px; font-weight:normal; background: none; " >  
                </th>
...
<div id="filter">
 ...
 <div class="root-visual_tags flex-tags" hidden>
...
<input id="tag_all" type="checkbox" name="tags"  value="<?php echo $row['site_category']; ?>" style=" margin-top: 20px;" checked>
...
<span><br>
  ...
  <input id="tags" class="tag_list" type="checkbox" name="tags"  value="<?php echo $row['site_category']; ?>" checked> 
...
<table class="table table-borderless mb-0">
    ...
    <thead>
      ...
      <tr>
                ...
                <th class="meta" style="color: black; font-size: 13px; font-weight:normal; width: 15%;" hidden> Times Aired Per Day </th>
...
// INPUT //                   
  ...
  var Price_per_Spots = 2;                           // Prices

// COMPUTE //
  var Hours_Days = Math.floor(Hours * Days);                   // Hours Multiply to Days
  var Hours_Days_Sites = Math.floor(Hours_Days * Sites);       // Hours And Days Multiply to Sites
  var Total = Math.floor(Hours_Days_Sites * Content_Spot);     // Hours and Days and Sites Multiply to Content Spot
  var Total_spots = Math.ceil(Total / Content_Spot);          // Total_spots Divide to Content Spot
  var Total_Amount = Math.floor(Total * Price_per_Spots);      // Hours and Days and Sites Multiply to Price per Spots
...
// OUTPUT //
  $('.Budget').empty().val(Total_Amount);                          // Total Amount
...
// COMPUTE //
  var Total_Spots_Per_Site = Math.ceil(Total_Frequency / Sites);                      // Total Spots Divide to Total Sites
...
// OUTPUT //
  $('.A_Total_Amount').empty().val(Total_Amount);
  ...
  $('.A_Total_prices_Cal').empty().val(Total_Amount);


// COMPUTE //
 var Time_Aired = Math.ceil(Total_Spots_Per_Site_Per_Day / 5); 
...
<!--
    ...
    <?php
      ...
      include 'database/database.php';
      $query = mysqli_query($con, "SELECT site_name, duration, AA, BB, CC, DD, EE,  SUM(duration) AS Duration,
                                                                                    SUM(AA) AS eigth_to_ten, 
                                                                                    SUM(BB) AS ten_to_twelve, 
                                                                                    SUM(CC) AS twelve_to_two, 
                                                                                    SUM(DD) AS two_to_four, 
                                                                                    SUM(EE) AS four_to_six,
                                                                                    SUM(AA) + SUM(BB) + SUM(CC) + SUM(DD) + SUM(EE) AS slot
      FROM playlist_video GROUP BY site_name LIMIT 1");
    ...
    ?>
                          ...
                          <br>
                          <span class="cell" style="color: black; font-size: 13px; font-weight:normal;"> Site - <?php echo $row['site_name'];?></span>
                          <br>
                          <span class="cell" style="color: black; font-size: 13px; font-weight:normal;"> Total Duration - 7200 Secs </span>
                          <br>
                          <span class="cell" style="color: black; font-size: 13px; font-weight:normal;"> Total Slot - 480 </span>
                          <br>
                          <br>
                          ...
                          <span class="cell" style="color: black; font-size: 13px; font-weight:normal;"> Consumed Duration - <?php echo $row['Duration'];?> Secs </span>
                          <br>
                          <span class="cell" style="color: black; font-size: 13px; font-weight:normal;"> Consumed Slot - <?php echo $row['slot'];?> Slot </span>
                          <br>
                          <br>

                <?php

                $start = ($row['eigth_to_ten']);
                $end = 480;

                $Available = (480 - $row['eigth_to_ten']) ;

                if ($start == $end) {
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 8 to 10 </span> - 
                       <input type='int' value='Not Available' readonly style='color: black; font-size: 13px; font-weight:normal;'> ";
                 ...
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 8 to 10 </span> - 
                       ...
                       <br> 
                       <span style='color: black; font-size: 13px; font-weight:normal;'> $start | Consumed Slot <br> $Available | Available Slot </span>";
                ...
                $start = ($row['ten_to_twelve']);
                $end = 480;

                $Available = (480 - $row['ten_to_twelve']);

                if ($start == $end) {
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 10 to 12 </span> - 
                       <input type='int' value='Not Available' readonly style='color: black; font-size: 13px; font-weight:normal;'> ";
                ...
                $start = ($row['twelve_to_two']);
                $end = 480;

                $Available = (480 - $row['twelve_to_two']);

                if ($start == $end) {
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 12 to 2 </span> - 
                       <input type='int' value='Not Available' readonly style='color: black; font-size: 13px; font-weight:normal;'> ";
                ...
                $start = ($row['two_to_four']);
                $end = 480;

                $Available = (480 - $row['two_to_four']);

                if ($start == $end) {
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 2 to 4 </span> - 
                       <input type='int' value='Not Available' readonly style='color: black; font-size: 13px; font-weight:normal;'> ";
                ...
                $start = ($row['four_to_six']);
                $end = 50;

                $Available = (480 - $row['four_to_six']);

                if ($start == $end) {
                 echo "<span style='color: black; font-size: 13px; font-weight:normal;'> 4 to 6 </span> - 
                       <input type='int' value='Not Available' readonly style='color: black; font-size: 13px; font-weight:normal;'> ";
