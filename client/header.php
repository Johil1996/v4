...
<body>
    ...
    <header class="app-header fixed-top">                   
      ...
      ?>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle" style="width: 120%;">

                        <li><a class="dropdown-item" href="../index.php?logout=<?php echo $user_type; ?>" style="">Log Out</a></li>
      ...
      <?php
         ...
         if($fetch['image'] == ''){
            echo '<a href="#"> <img src="../profile/default-avatar.png" style="border-radius: 100px; width: 40%; margin-left: 30%"> </a>';
         }else{
            echo '<a href="#">  <img src="../profile/'.$fetch['image'].'" style="border-radius: 100px; width: 40%; margin-left: 30%"> </a>';
         }
      ?>
    ...
    <script src="table/vendors/simple-datatables/videofil.js"></script>
